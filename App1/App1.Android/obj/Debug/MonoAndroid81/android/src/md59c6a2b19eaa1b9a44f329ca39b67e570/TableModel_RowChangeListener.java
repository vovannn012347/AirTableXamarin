...
public class TableModel_RowChangeListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("App1.Droid.Table.Models.TableModel+RowChangeListener, App1.Android", TableModel_RowChangeListener.class, __md_methods);
	}


	public TableModel_RowChangeListener ()
	{
		super ();
		if (getClass () == TableModel_RowChangeListener.class)
			mono.android.TypeManager.Activate ("App1.Droid.Table.Models.TableModel+RowChangeListener, App1.Android", "", this, new java.lang.Object[] {  });
	}
