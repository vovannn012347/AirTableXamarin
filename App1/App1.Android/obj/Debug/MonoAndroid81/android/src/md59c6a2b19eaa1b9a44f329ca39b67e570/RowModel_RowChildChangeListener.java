...
public class RowModel_RowChildChangeListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("App1.Droid.Table.Models.RowModel+RowChildChangeListener, App1.Android", RowModel_RowChildChangeListener.class, __md_methods);
	}


	public RowModel_RowChildChangeListener ()
	{
		super ();
		if (getClass () == RowModel_RowChildChangeListener.class)
			mono.android.TypeManager.Activate ("App1.Droid.Table.Models.RowModel+RowChildChangeListener, App1.Android", "", this, new java.lang.Object[] {  });
	}
