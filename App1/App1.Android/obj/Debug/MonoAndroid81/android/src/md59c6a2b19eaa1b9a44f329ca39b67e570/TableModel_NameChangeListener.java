...
public class TableModel_NameChangeListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("App1.Droid.Table.Models.TableModel+NameChangeListener, App1.Android", TableModel_NameChangeListener.class, __md_methods);
	}


	public TableModel_NameChangeListener ()
	{
		super ();
		if (getClass () == TableModel_NameChangeListener.class)
			mono.android.TypeManager.Activate ("App1.Droid.Table.Models.TableModel+NameChangeListener, App1.Android", "", this, new java.lang.Object[] {  });
	}
