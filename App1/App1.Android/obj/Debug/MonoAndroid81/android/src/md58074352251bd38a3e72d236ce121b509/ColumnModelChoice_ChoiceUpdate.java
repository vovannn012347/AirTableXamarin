package md58074352251bd38a3e72d236ce121b509;


public class ColumnModelChoice_ChoiceUpdate
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("App1.Droid.Table.Models.Columns.ColumnModelChoice+ChoiceUpdate, App1.Android", ColumnModelChoice_ChoiceUpdate.class, __md_methods);
	}


	public ColumnModelChoice_ChoiceUpdate ()
	{
		super ();
		if (getClass () == ColumnModelChoice_ChoiceUpdate.class)
			mono.android.TypeManager.Activate ("App1.Droid.Table.Models.Columns.ColumnModelChoice+ChoiceUpdate, App1.Android", "", this, new java.lang.Object[] {  });
	}
